...
var _require = require('./knowledge'),
  Knowledge = _require.Knowledge;
...
mongoose.connect(process.env.MONGO_URI).then(function () {
  return console.log("Connected to MongoDB for seeding");
})["catch"](function (err) {
...
function _seedDB() {
  _seedDB = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return Knowledge.insertMany(seedData);
        case 3:
        ...
        case 7:
          ...
          console.error("Seeding error:", _context.t0);
        case 10:
        case "end":
