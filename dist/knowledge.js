...
var tendermintRpcUrl = process.env.TENDERMINT_RPC_URL;
var lcdRestUrl = process.env.LCD_REST_URL;
var evmJsonRpcUrl = process.env.EVM_JSON_RPC_URL;
 ...
 */
function findAnswer(_x) {
  return _findAnswer.apply(this, arguments);
}
function _findAnswer() {
  _findAnswer = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(query) {
    var record, dataPath, rawData, staticData;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 9:
          _context.prev = 9;
          dataPath = path.join(__dirname, '../data/knowledge.json');
          rawData = fs.readFileSync(dataPath);
          staticData = JSON.parse(rawData); // Esegui una ricerca "manuale" nel file, ad esempio controllando se la domanda è presente tra le chiavi
          ...
          return _context.abrupt("return", {
            answer: staticData.about.description,
            source: "Static Data"
          });
        case 15:
          ...
          return _context.abrupt("return", {
            answer: "Token Name: ".concat(staticData.token.name, ", Symbol: ").concat(staticData.token.symbol),
            source: "Static Data"
          });
        case 17:
          _context.next = 22;
        ...
        case 19:
          ...
          console.error("Errore nel caricamento dei dati statici:", _context.t0);
        case 22:
